...
public class Main {
    public static void main(String[] args) {
        ...
        // Agregar plazas a los pisos
        piso1.agregarPlaza(plaza1);
        piso1.agregarPlaza(plaza2);
        piso2.agregarPlaza(plaza3);
        piso2.agregarPlaza(plaza4);
        System.out.println("");
        ...
        ClienteRegular cliente1 = new ClienteRegular("Daniel", "Pardo", "1105647896", "0957846842", "Tarjeta de credito");
        ClienteRegular cliente2 = new ClienteRegular("Andres", "Rojas", "1187456312", "0658974563", "Transferencia");
        ClienteRegular cliente3 = new ClienteRegular("Kevin", "Valladolid", "1174586894", "0924567896", "Efectivo");
